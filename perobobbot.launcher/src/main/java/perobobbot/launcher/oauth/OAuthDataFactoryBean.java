...
@Singleton
public class OAuthDataFactoryBean implements OAuthDataFactory {
    ...
    public @NonNull OAuthData create(@NonNull UserIdentity userIdentity) {
        return new OAuthDataBean(userIdentity,userTokenService,applicationService,oAuthManager,instants);
    }
}
