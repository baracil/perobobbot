...
public class ChannelPollBeginEvent extends PollEvent {
    ...
    public ChannelPollBeginEvent(@NonNull String id,
                                 @NonNull UserInfo broadcaster,
                                 @NonNull String title,
                                 @NonNull List<PollChoices> choices,
                                 @NonNull Voting bitsVoting,
                                 @NonNull Voting channelPointsVoting,
                                 @NonNull @Serdeable.Deserializable(using = ISOInstantSerde.class) Instant startedAt,
                                 @NonNull @Serdeable.Deserializable(using = ISOInstantSerde.class) Instant endsAt) {
