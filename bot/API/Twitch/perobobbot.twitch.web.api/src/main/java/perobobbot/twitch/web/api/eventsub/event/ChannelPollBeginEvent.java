...
public class ChannelPollBeginEvent extends PollEvent {
    ...
    public ChannelPollBeginEvent(@NonNull String id, @NonNull UserInfo broadcaster, @NonNull String title, @NonNull ImmutableList<PollChoices> choices, @NonNull Voting bitsVoting, @NonNull Voting channelPointsVoting, @NonNull Instant startedAt, @NonNull Instant endsAt) {
