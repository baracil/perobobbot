...
public class TwitchChatInfo extends ChatInfo<MessageFromTwitch> {
    ...
    @Builder
    public TwitchChatInfo(String nick,
                          Instants instants,
                          ChatStateListener<MessageFromTwitch> chatStateListener,
                          ReconnectionPolicy reconnectionPolicy,
                          TwitchBandwidth twitchBandwidth) {
        super(
    ...
    public static TwitchChatInfoBuilder builder(String nick, Instants instants, ChatStateListener<MessageFromTwitch> chatStateListener) {
